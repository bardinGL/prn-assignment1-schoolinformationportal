...
=======
                optionsBuilder.UseSqlServer("Server= (local);uid=sa;pwd=12345;database=StudentInfo;TrustServerCertificate=True");
>>>>>>> master
            }
        }
        ...
        private string GetConnectionString()
        {
            IConfiguration config = new ConfigurationBuilder()
                ...
                .Build();
            var strConn = config["ConnectionStrings:StudentInfo"];
            return strConn;
        }
